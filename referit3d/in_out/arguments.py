...
def parse_arguments(notebook_options=None):
    ...
    parser.add_argument('-scannet-file', 
        default="/mnt/petrelfs/zhaolin/files/Asrclin/data/scannet/infos/keep_all_points_00_view_with_global_scan_alignment.pkl",
        type=str, required=False, help='pkl file containing the data of Scannet'
                                                                       ' as generated by running XXX')
    parser.add_argument('-referit3D-file', 
        default="/mnt/petrelfs/zhaolin/files/Asrclin/data/scannet/infos/nr3d.csv",
        type=str, required=False)

    #
    # I/O file-related arguments
    #
    parser.add_argument('--log-dir',default="/mnt/petrelfs/zhaolin/projects/3d/MVT-3DVG/output",type=str, help='where to save training-progress, model, etc')
    ...
    parser.add_argument('--bert-pretrain-path', type=str, default="/mnt/petrelfs/zhaolin/files/Asrclin/data/scannet/BertModels")
